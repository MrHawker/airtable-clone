...
export function BaseCards() {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      {bases?.map((base) =>(
        <div onClick={() => router.push(`/base/${base.createdById}/${base.id}`)} key={base.id} className="p-4 flex border-2 rounded-md bg-white flex-grow md:basis-1/2 lg:basis-1/4 md:flex-none shadow-sm hover:shadow-md hover:cursor-pointer">
