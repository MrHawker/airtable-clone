    ...
    return (
        <main>
            ...
            <nav className="flex flex-col py-[8px]">
                ...
                <button onClick={()=>signIn('google',{redirectTo:'/dashboard'})} className=" px-[24px] py-[16px] hover:text-hover-blue transition ease-in-out duration-300"><span className="text-lg font-semibold  flex">Sign In</span></button>
            </nav>
