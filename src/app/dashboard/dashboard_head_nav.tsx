...
export function DashboardHeadNav({
    ...
    setMenuExtended:React.Dispatch<React.SetStateAction<boolean>>,
    ...
    <header className="sticky top-0 shadow-sm border-b-2 bg-white z-30 px-2">
        <nav className="flex justify-between items-center py-1">
            <div className="flex items-center space-x-4">
                {isDesktop && <CiMenuBurger onClick={()=>setMenuExtended(!menuExtended)} style={{fontSize:'30px'}} className="pl-[8px] pr-[4px] hover:text-black text-slate-400 hover:cursor-pointer"/>}
